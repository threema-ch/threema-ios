...
// MARK: - NSString + Unpackable

extension NSString: Unpackable { }

// MARK: - Bool + Unpackable
...
// MARK: - Bool + DataConvertible

extension Bool: DataConvertible { }

// MARK: - Int8 + DataConvertible

extension Int8: DataConvertible { }

// MARK: - Int16 + DataConvertible

extension Int16: DataConvertible { }

// MARK: - Int32 + DataConvertible

extension Int32: DataConvertible { }

// MARK: - Int64 + DataConvertible

extension Int64: DataConvertible { }

// MARK: - UInt8 + DataConvertible

extension UInt8: DataConvertible { }

// MARK: - UInt16 + DataConvertible

extension UInt16: DataConvertible { }

// MARK: - UInt32 + DataConvertible

extension UInt32: DataConvertible { }

// MARK: - UInt64 + DataConvertible

extension UInt64: DataConvertible { }

// MARK: - Float32 + DataConvertible

extension Float32: DataConvertible { }

// MARK: - Float64 + DataConvertible
...
extension String {
    subscript(from: Int, to: Int) -> String {
        NSString(string: self).substring(with: NSMakeRange(from, to - from))
    }
}
...
public func pack(
    _ format: String,
    _ objects: [Any],
    _ stringEncoding: String.Encoding = String.Encoding.windowsCP1252
) -> Data {
    ...
    while !mutableFormat.isEmpty {
        ...
        if c == "s" {
            ...
            if bytes.count > expectedSize {
                bytes = Array(bytes[0..<expectedSize])
            }
...
public func unpack(
    ...
    assert(
        CFByteOrderGetCurrent() == 1 /* CFByteOrderLittleEndian */,
