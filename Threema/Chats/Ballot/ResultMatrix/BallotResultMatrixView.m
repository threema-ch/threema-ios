...
#define BORDER_COLOR Colors.hairLineBallot
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = Colors.backgroundNavigationController;
    }
    return self;
}
...
- (NSString*)createNotVotedString {
    ...
    return [NSString stringWithFormat:@"%@\n%@", [BundleUtil localizedStringForKey:@"ballot_not_voted"], [_notParticipantNames componentsJoinedByString:@", "]];
}
