...
- (UIView *)customViewInRect:(CGRect)rect {
    ...
    if (!([fileMessage renderMediaFileMessage] || [fileMessage renderStickerFileMessage])) {
        ...
        labelRight.text = [Utils formatDataLength:fileMessage.fileSize.floatValue];
        ...
        labelLeft.text = fileMessage.fileName;
