...
- (void)setup {
    ...
    _yesButton.backgroundColor = [Colors mainThemeDark];
    [_yesButton setTitleColor:[Colors white] forState:UIControlStateNormal];
    ...
    [_noButton setTitleColor:[Colors mainThemeDark] forState:UIControlStateNormal];
}
