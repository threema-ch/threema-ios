...
- (void)invite {
    ShareTextActivityItemProvider *shareText = [[ShareTextActivityItemProvider alloc] initWithPlaceholderItem:[NSString stringWithFormat:NSLocalizedString(@"invite_facebook_text", @""), [[MyIdentityStore sharedMyIdentityStore] identity]]];
...
- (void)presentMailComposer {
    ...
    [mailComposer setSubject:NSLocalizedString(@"invite_email_subject", nil)];
    [mailComposer setMessageBody:[NSString stringWithFormat:NSLocalizedString(@"invite_email_body", @""), [[MyIdentityStore sharedMyIdentityStore] identity]] isHTML:NO];
...
- (void)presentMessageComposer {
    ...
    [smsComposer setBody:[NSString stringWithFormat:NSLocalizedString(@"invite_sms_body", @""), [[MyIdentityStore sharedMyIdentityStore] identity]]];
