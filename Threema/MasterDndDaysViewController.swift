...
class MasterDndDaysViewController: ThemedTableViewController {
    ...
    var selectedIndexPaths:NSMutableOrderedSet = NSMutableOrderedSet()

    override func viewDidLoad() {
        super.viewDidLoad()
        
        self.title = BundleUtil.localizedString(forKey: "settings_notifications_masterDnd_workingDays")
    }

    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        
        selectedIndexPaths = NSMutableOrderedSet.init(orderedSet: UserSettings.shared().masterDndWorkingDays)
