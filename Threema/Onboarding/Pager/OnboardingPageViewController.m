...
@interface OnboardingPageViewController () <PageViewDataSource, PageViewDelegate, PageContentControllerDelegate>
...
- (void)setup {
    ...
    [_pageLeftButton setImage:[[UIImage systemImageNamed:@"chevron.left"] imageWithTintColor:UIColor.tintColor] forState:UIControlStateNormal];
    _pageLeftButton.imageView.contentMode = UIViewContentModeScaleAspectFit;
    [_pageRightButton setImage:[[UIImage systemImageNamed:@"chevron.right"] imageWithTintColor:UIColor.tintColor] forState:UIControlStateNormal];
...
- (void)hideControls:(BOOL)hideControls {
    ...
    CGRect rect = CGRectMake(_controlsView.frame.origin.x, yOffset, _controlsView.frame.size.width, _controlsView.frame.size.height);
