...
- (void)setup {
    ...
    _scanLabel.textColor = [Colors mainThemeDark];
    ...
    _scanView.layer.borderColor = [Colors mainThemeDark].CGColor;
    _scanView.isAccessibilityElement = YES;
    ...
    _cancelButton.layer.borderColor = [Colors mainThemeDark].CGColor;
    ...
    _doneButton.backgroundColor = [Colors mainThemeDark];
    [_doneButton setTitleColor:[Colors white] forState:UIControlStateNormal];
    
    [_cancelButton setTitleColor:[Colors mainThemeDark] forState:UIControlStateNormal];
    ...
    _scanImageView.image = [UIImage imageNamed:@"QRScan" inColor:[Colors mainThemeDark]];
    
    _backupTextView.accessibilityIdentifier = @"backupTextView";
    
    _backupTextView.tintColor = [Colors mainThemeDark];
    _passwordTextField.tintColor = [Colors mainThemeDark];
