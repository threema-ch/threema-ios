...
class ReadReceiptsSettingsViewController: ThemedTableViewController {
...
extension ReadReceiptsSettingsViewController {
...
extension ReadReceiptsSettingsViewController {
    ...
    private func resetContactsToDefault() {
        ...
        guard let contacts = entityManager.entityFetcher.contactsWithCustomReadReceipt() as? [Contact] else {
            return
        }
