    ...
    if ([self parseScannedContact:result identity:&_scannedIdentity publicKey:&_scannedPublicKey expirationDate:&_scannedExpirationDate]) {
        ...
        if (existingContact != nil) {
            ...
            if (![existingContact.publicKey isEqualToData:scannedPublicKey]) {
                ...
                [[ContactStore sharedContactStore] upgradeContact:existingContact toVerificationLevel:ContactVerificationLevelFullyVerified];
        ...
        if (qrCodeWithData != nil) {
            ...
            NSString *message = [NSString stringWithFormat:[BundleUtil localizedStringForKey:@"scanned_non_threema_id_message"], TargetManagerObjc.appName];
