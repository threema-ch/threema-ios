...
- (void)setup {
    if ([LicenseStore requiresLicenseKey]) {
        _titleLabel.text = [BundleUtil localizedStringForKey:@"id_sync_title_work"];
        _descriptionLabel.text = [BundleUtil localizedStringForKey:@"id_sync_description_work"];        
    } else {
    ...
    self.moreView.moreMessageText = [BundleUtil localizedStringForKey:@"more_information_sync_contacts"];
    ...
    _syncContactsSwitch.onTintColor = [Colors mainThemeDark];
}
