...
+ (NSAttributedString*)makeAttributedStringFromString:(NSString*)string withFont:(UIFont*)font textColor:(UIColor *)textColor isOwn:(BOOL)isOwn application:(UIApplication *)application {
    ...
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:string attributes:@{NSFontAttributeName: font, NSForegroundColorAttributeName: textColor ? textColor : [Colors fontNormal]}];
    [detector enumerateMatchesInString:string options:0 range:NSMakeRange(0, string.length) usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
        ...
        attributes[@"ZSWTappableLabelHighlightedForegroundAttributeName"] = isOwn == true ? [Colors fontLink] : [Colors fontLinkReceived];
        attributes[NSForegroundColorAttributeName] = isOwn == true ? [Colors fontLink] : [Colors fontLinkReceived];
...
+ (NSAttributedString *)makeMentionsAttributedStringForAttributedString:(NSMutableAttributedString *)text textFont:(UIFont *)textFont atColor:(UIColor *)atColor messageInfo:(int)messageInfo application:(UIApplication *)application {
    ...
    while (!finished) {
        ...
        Contact *contact = [[ContactStore sharedContactStore] contactForIdentity:identity];
        NSMutableDictionary *paddingAttributeLeft = [[NSMutableDictionary alloc] initWithDictionary:@{@"TTTBackgroundFillColor": [Colors mentionBackground:messageInfo],
                                                                                             NSForegroundColorAttributeName: [Colors mentionBackground:messageInfo],
        ...
        NSMutableDictionary *paddingAttributeRight = [[NSMutableDictionary alloc] initWithDictionary:@{@"TTTBackgroundFillColor": [Colors mentionBackground:messageInfo],
                                                                                                  NSForegroundColorAttributeName: [Colors mentionBackground:messageInfo],
                                                                                                  NSTextEffectAttributeName: NSTextEffectLetterpressStyle,
                                                                                                  @"TTTBackgroundCornerRadius": [NSNumber numberWithFloat:3.0f],
                                                                                                  @"ZSWTappableLabelTappableRegionAttributeName": @NO,
                                                                                                  @"TTTBackgroundFillPadding": [NSNumber valueWithUIEdgeInsets:UIEdgeInsetsMake(-1, 5, -1, 0)]                                                                                         }];
        NSMutableDictionary *attributeAt = [[NSMutableDictionary alloc] initWithDictionary:@{@"TTTBackgroundFillColor": [Colors mentionBackground:messageInfo],
        ...
        if (contact || [identity isEqualToString:[[MyIdentityStore sharedMyIdentityStore] identity]] || [identity isEqualToString:@"@@@@@@@@"]) {
            NSMutableDictionary *attributes = [[NSMutableDictionary alloc] initWithDictionary:@{@"TTTBackgroundFillColor": [Colors mentionBackground:messageInfo],
                                                                                                NSTextEffectAttributeName: NSTextEffectLetterpressStyle,
                                                                                                @"TTTBackgroundCornerRadius": [NSNumber numberWithFloat:0.0f],
                                                                                                @"TTTBackgroundFillPadding": [NSNumber valueWithUIEdgeInsets:UIEdgeInsetsMake(-1, 0, -1, 0)]
                                                                                                }];
            ...
            if (contact) {
                ...
                [attributes setObject:[Colors fontNormal] forKey:NSForegroundColorAttributeName];
                ...
                displayName = [BundleUtil localizedStringForKey:@"mentions_all"];
                [paddingAttributeLeft setObject:[Colors mentionBackgroundMe:messageInfo] forKey:@"TTTBackgroundFillColor"];
                [paddingAttributeLeft setObject:[Colors mentionBackgroundMe:messageInfo] forKey:NSForegroundColorAttributeName];
                
                [paddingAttributeRight setObject:[Colors mentionBackgroundMe:messageInfo] forKey:@"TTTBackgroundFillColor"];
                [paddingAttributeRight setObject:[Colors mentionBackgroundMe:messageInfo] forKey:NSForegroundColorAttributeName];
                
                [attributeAt setObject:[Colors mentionBackgroundMe:messageInfo] forKey:@"TTTBackgroundFillColor"];
                [attributeAt setObject:[[Colors mentionTextMe:messageInfo] colorWithAlphaComponent:0.6] forKey:NSForegroundColorAttributeName];
                
                [attributes setObject:[Colors mentionBackgroundMe:messageInfo] forKey:@"TTTBackgroundFillColor"];
                [attributes setObject:[Colors mentionTextMe:messageInfo] forKey:NSForegroundColorAttributeName];
            } else {
                // me
