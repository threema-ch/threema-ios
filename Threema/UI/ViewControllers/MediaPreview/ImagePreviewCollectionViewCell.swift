...
class ImagePreviewCollectionViewCell: UICollectionViewCell, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    func addAccessibilityLabels() {
        self.imageView.accessibilityLabel = String(format: NSLocalizedString("image", comment: ""))
        self.loadingView.accessibilityLabel = String(format: NSLocalizedString("loading_image", comment: ""))
    }
    ...
    func setColors() {
        ...
        self.loadingView.backgroundColor = Colors.background()
    ...
    func showLoadingScreen() {
        ...
        UIView.animate(withDuration: 0.1, animations: {
            ...
            self.loadingText.text = String(format: NSLocalizedString("loading_image", comment: ""))
