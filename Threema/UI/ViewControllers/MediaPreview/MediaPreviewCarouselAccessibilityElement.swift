...
class MediaPreviewCarouselAccessibilityElement : UIAccessibilityElement {
    ...
    override var accessibilityLabel: String? {
        get {
            let text = String(format: NSLocalizedString("selected_media_list", comment: ""))
            return text
        }
        set {
    ...
    override var accessibilityValue: String? {
        get {
            let text = String(format: NSLocalizedString("media_item_of", comment: ""), "\(currentMediaItem!.item + 1)", " \(getTotalItems())")
