...
class WebBatteryStatusUpdate: WebAbstractMessage {
    ...
    init(_ requestId: String? = nil) {
        ...
        isCharging = batteryState == .full || batteryState == .charging
        
        let tmpArgs:[AnyHashable:Any?] = [AnyHashable:Any?]()
        ...
        super.init(messageType: "update", messageSubType: "batteryStatus", requestId: nil, ack: tmpAck, args: tmpArgs, data: tmpData)
    }
}
