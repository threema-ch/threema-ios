...
class WebCreateTextMessageResponse: WebAbstractMessage {
    ...
    init(message:BaseMessage, request: WebCreateTextMessageRequest) {
        ...
        let tmpAck = WebAbstractMessageAcknowledgement.init(request.requestId, success, error)
        
        super.init(messageType: "create", messageSubType: "textMessage", requestId: nil, ack: tmpAck, args: tmpArgs, data: tmpData)
    }
    ...
    init(request: WebCreateTextMessageRequest) {
        ...
        super.init(messageType: "create", messageSubType: "textMessage", requestId: nil, ack: tmpAck, args: tmpArgs, data: nil)
    }
}
