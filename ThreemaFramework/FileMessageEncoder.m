...
+ (BoxFileMessage *)encodeFileMessage:(FileMessage *)message {
...
+ (GroupFileMessage *)encodeGroupFileMessage:(FileMessage *)message {
    NSData *jsonData = [self jsonDataForMessage:message];
...
+ (NSString *)jsonStringForMessage:(FileMessage *)message {
    NSData *jsonData = [self jsonDataForMessage:message];
    return [[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
}

+ (NSData *)jsonDataForMessage:(FileMessage *)message {
