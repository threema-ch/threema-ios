    ...
    override var accessibilityElements: [Any]? {
        get {
            ...
            if let theCarouselAccessibilityElement = self.carouselAccessibilityElement {
                ...
                carAccessibilityElement = MediaPreviewCarouselAccessibilityElement(accessibilityContainer: self, currentMediaItem: self.delegate?.getCurrentlyVisibleItem())
                index+=1
                
                carAccessibilityElement.accessibilityFrameInContainerSpace = self.frame
            }
            
            carAccessibilityElements = [carAccessibilityElement]
            self.carouselAccessibilityElement = carAccessibilityElement
