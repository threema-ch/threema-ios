...
class VideoImageCell: ScreenWidthSizedCell, UIGestureRecognizerDelegate {
    ...
    func addAccessibilityLabels() {
        self.videoBackgroundView.accessibilityLabel =  BundleUtil.localizedString(forKey:"video")
        self.loadingView.accessibilityLabel = BundleUtil.localizedString(forKey:"loading_video")
    }
