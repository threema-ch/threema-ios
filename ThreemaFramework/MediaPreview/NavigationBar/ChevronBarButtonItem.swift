...
class ChevronBarButtonItem: UIButton {
    ...
    func asLeftBarButtonItem() -> [UIBarButtonItem] {
        ...
        spacer.width = configuration.offsetCorrection
    ...
    private let configuration = ChevronBarButtonItem.Configuration()
    ...
    public static func drawImage() -> UIImage {
        return ChevronBackCircleImage.get()
    }
    ...
    override var intrinsicContentSize: CGSize {
        ...
        return CGSize(width: configuration.minimumTouchTargetWidth - configuration.offsetCorrection, height: UIView.layoutFittingExpandedSize.height)
    }
    
    override var alignmentRectInsets: UIEdgeInsets {
        return UIEdgeInsets(top: 0, left: configuration.offsetCorrection, bottom: 0, right: 0)
    }
