...
public final class EntityObserver: NSObject {

    public static let shared = EntityObserver()

    public typealias EntityChangedAction = (NSManagedObject?, EntityChangedReason) -> Void

    public enum EntityChangedReason {
        case updated
        case deleted
    }
