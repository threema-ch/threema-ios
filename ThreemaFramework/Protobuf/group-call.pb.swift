...
struct Groupcall_CallState {
  ...
  var stateCreatedBy: UInt32 = 0

  /// UNIX-ish timestamp in milliseconds the designated client created this
  /// message.
  var stateCreatedAt: UInt64 = 0

  /// Information for each participant of the group call.
  var participants: Dictionary<UInt32,Groupcall_CallState.Participant> = [:]
  ...
  struct Participant {
    ...
    var threema: Groupcall_CallState.Participant.Normal {
      get {
    ...
    var guest: Groupcall_CallState.Participant.Guest {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_CallState.Participant.OneOf_Participant, rhs: Groupcall_CallState.Participant.OneOf_Participant) -> Bool {
...
struct Groupcall_SfuHttpRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Groupcall_SfuHttpResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct Peek {
    ...
    var hasEncryptedCallState: Bool {return self._encryptedCallState != nil}
    /// Clears the value of `encryptedCallState`. Subsequent reads from it will return its default value.
    mutating func clearEncryptedCallState() {self._encryptedCallState = nil}
  ...
  struct Join {
    ...
    var addresses: [Groupcall_SfuHttpResponse.Join.Address] = []

    /// ICE username fragment for the WebRTC connection.
    var iceUsernameFragment: String = String()

    /// ICE password for the WebRTC connection.
    var icePassword: String = String()
    ...
    struct Address {
      ...
      var `protocol`: Groupcall_SfuHttpResponse.Join.Address.ProtocolEnum = .udp
...
extension Groupcall_SfuHttpResponse.Join.Address.ProtocolEnum: CaseIterable {
  ...
  static var allCases: [Groupcall_SfuHttpResponse.Join.Address.ProtocolEnum] = [
    .udp,
  ]
}
...
/// - `negotiated`: `true`
/// - `id`: `0`
struct Groupcall_SfuToParticipant {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct Envelope {
    ...
    var content: Groupcall_SfuToParticipant.Envelope.OneOf_Content? = nil

    var relay: Groupcall_ParticipantToParticipant.OuterEnvelope {
      get {
    ...
    var hello: Groupcall_SfuToParticipant.Hello {
      get {
    ...
    var participantLeft: Groupcall_SfuToParticipant.ParticipantLeft {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_SfuToParticipant.Envelope.OneOf_Content, rhs: Groupcall_SfuToParticipant.Envelope.OneOf_Content) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
...
/// - `negotiated`: `true`
/// - `id`: `0`
struct Groupcall_ParticipantToSfu {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct Envelope {
    ...
    var content: Groupcall_ParticipantToSfu.Envelope.OneOf_Content? = nil
    ...
    var updateCallState: Groupcall_ParticipantToSfu.UpdateCallState {
      get {
    ...
    var requestParticipantMicrophone: Groupcall_ParticipantToSfu.ParticipantMicrophone {
      get {
    ...
    var requestParticipantCamera: Groupcall_ParticipantToSfu.ParticipantCamera {
      get {
    ...
    var requestParticipantScreenShare: Groupcall_ParticipantToSfu.ParticipantScreen {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToSfu.Envelope.OneOf_Content, rhs: Groupcall_ParticipantToSfu.Envelope.OneOf_Content) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  struct UpdateCallState {
    ...
    /// a random nonce.
    var encryptedCallState: Data = Data()
  ...
  struct ParticipantMicrophone {
    ...
    var action: Groupcall_ParticipantToSfu.ParticipantMicrophone.OneOf_Action? = nil

    var subscribe: Groupcall_ParticipantToSfu.ParticipantMicrophone.Subscribe {
      get {
    ...
    var unsubscribe: Groupcall_ParticipantToSfu.ParticipantMicrophone.Unsubscribe {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.OneOf_Action, rhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.OneOf_Action) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  struct ParticipantCamera {
    ...
    var action: Groupcall_ParticipantToSfu.ParticipantCamera.OneOf_Action? = nil

    var subscribe: Groupcall_ParticipantToSfu.ParticipantCamera.Subscribe {
      get {
        if case .subscribe(let v)? = action {return v}
    ...
    var unsubscribe: Groupcall_ParticipantToSfu.ParticipantCamera.Unsubscribe {
      get {
        if case .unsubscribe(let v)? = action {return v}
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantCamera.OneOf_Action, rhs: Groupcall_ParticipantToSfu.ParticipantCamera.OneOf_Action) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
    ...
    struct Subscribe {
      ...
      /// fits best.
      var desiredResolution: Common_Resolution {
  ...
  struct ParticipantScreen {
    ...
    var action: Groupcall_ParticipantToSfu.ParticipantScreen.OneOf_Action? = nil

    var subscribe: Groupcall_ParticipantToSfu.ParticipantScreen.Subscribe {
      get {
        if case .subscribe(let v)? = action {return v}
    ...
    var unsubscribe: Groupcall_ParticipantToSfu.ParticipantScreen.Unsubscribe {
      get {
        if case .unsubscribe(let v)? = action {return v}
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantScreen.OneOf_Action, rhs: Groupcall_ParticipantToSfu.ParticipantScreen.OneOf_Action) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
...
struct Groupcall_ParticipantToParticipant {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct Handshake {
    ...
    struct HelloEnvelope {
      ...
      var content: Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope.OneOf_Content? = nil

      var hello: Groupcall_ParticipantToParticipant.Handshake.Hello {
        get {
          if case .hello(let v)? = content {return v}
      ...
      var guestHello: Groupcall_ParticipantToParticipant.Handshake.GuestHello {
        get {
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope.OneOf_Content, rhs: Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope.OneOf_Content) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
    ...
    struct AuthEnvelope {
      ...
      var content: Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope.OneOf_Content? = nil

      var auth: Groupcall_ParticipantToParticipant.Handshake.Auth {
        get {
      ...
      var guestAuth: Groupcall_ParticipantToParticipant.Handshake.GuestAuth {
        get {
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope.OneOf_Content, rhs: Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope.OneOf_Content) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
    ...
    struct Auth {
      ...
      /// present.
      var mediaKeys: [Groupcall_ParticipantToParticipant.MediaKey] = []
  ...
  struct Envelope {
    ...
    var content: Groupcall_ParticipantToParticipant.Envelope.OneOf_Content? = nil

    /// An `Admin.Envelope`, encrypted as described by that message.
    var encryptedAdminEnvelope: Data {
      get {
    ...
    var rekey: Groupcall_ParticipantToParticipant.MediaKey {
      get {
    ...
    var captureState: Groupcall_ParticipantToParticipant.CaptureState {
      get {
    ...
    var holdState: Groupcall_ParticipantToParticipant.HoldState {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToParticipant.Envelope.OneOf_Content, rhs: Groupcall_ParticipantToParticipant.Envelope.OneOf_Content) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  struct Admin {
    ...
    struct Envelope {
      ...
      var content: Groupcall_ParticipantToParticipant.Admin.Envelope.OneOf_Content? = nil

      var reportAsAdmin: Groupcall_ParticipantToParticipant.Admin.ReportAsAdmin {
        get {
      ...
      var promoteToAdmin: Groupcall_ParticipantToParticipant.Admin.PromoteToAdmin {
        get {
      ...
      var forceLeave: Groupcall_ParticipantToParticipant.Admin.ForceLeave {
        get {
      ...
      var forceCaptureStateOff: Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff {
        get {
      ...
      var forceFocus: Groupcall_ParticipantToParticipant.Admin.ForceFocus {
        get {
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.Envelope.OneOf_Content, rhs: Groupcall_ParticipantToParticipant.Admin.Envelope.OneOf_Content) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
    ...
    struct ForceCaptureStateOff {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.

      var device: Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff.Device = .all

      var unknownFields = SwiftProtobuf.UnknownStorage()

      enum Device: SwiftProtobuf.Enum {
        typealias RawValue = Int
  ...
  struct CaptureState {
    ...
    var state: Groupcall_ParticipantToParticipant.CaptureState.OneOf_State? = nil

    var microphone: Groupcall_ParticipantToParticipant.CaptureState.Microphone {
      get {
    ...
    var camera: Groupcall_ParticipantToParticipant.CaptureState.Camera {
      get {
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.OneOf_State, rhs: Groupcall_ParticipantToParticipant.CaptureState.OneOf_State) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
    ...
    struct Microphone {
      ...
      var state: Groupcall_ParticipantToParticipant.CaptureState.Microphone.OneOf_State? = nil
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Microphone.OneOf_State, rhs: Groupcall_ParticipantToParticipant.CaptureState.Microphone.OneOf_State) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
    ...
    struct Camera {
      ...
      var state: Groupcall_ParticipantToParticipant.CaptureState.Camera.OneOf_State? = nil
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Camera.OneOf_State, rhs: Groupcall_ParticipantToParticipant.CaptureState.Camera.OneOf_State) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
    ...
    struct Screen {
      ...
      var state: Groupcall_ParticipantToParticipant.CaptureState.Screen.OneOf_State? = nil
      ...
      #if !swift(>=4.1)
        static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Screen.OneOf_State, rhs: Groupcall_ParticipantToParticipant.CaptureState.Screen.OneOf_State) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
...
extension Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff.Device: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff.Device] = [
    .all,
    .microphone,
    .camera,
    .screen,
...
extension Groupcall_CallState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Groupcall_CallState, rhs: Groupcall_CallState) -> Bool {
...
extension Groupcall_CallState.Participant.Normal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_CallState.Participant.protoMessageName + ".Normal"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_CallState.Participant.Normal, rhs: Groupcall_CallState.Participant.Normal) -> Bool {
...
extension Groupcall_CallState.Participant.Guest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_CallState.Participant.protoMessageName + ".Guest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ]
  ...
  static func ==(lhs: Groupcall_CallState.Participant.Guest, rhs: Groupcall_CallState.Participant.Guest) -> Bool {
...
extension Groupcall_SfuHttpRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SfuHttpRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_SfuHttpRequest, rhs: Groupcall_SfuHttpRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_SfuHttpRequest.Peek: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuHttpRequest.protoMessageName + ".Peek"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_SfuHttpRequest.Peek, rhs: Groupcall_SfuHttpRequest.Peek) -> Bool {
...
extension Groupcall_SfuHttpRequest.Join: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuHttpRequest.protoMessageName + ".Join"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "call_id"),
  ...
  static func ==(lhs: Groupcall_SfuHttpRequest.Join, rhs: Groupcall_SfuHttpRequest.Join) -> Bool {
    if lhs.callID != rhs.callID {return false}
...
extension Groupcall_SfuHttpResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SfuHttpResponse"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_SfuHttpResponse, rhs: Groupcall_SfuHttpResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_SfuHttpResponse.Peek: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuHttpResponse.protoMessageName + ".Peek"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_SfuHttpResponse.Peek, rhs: Groupcall_SfuHttpResponse.Peek) -> Bool {
...
extension Groupcall_SfuHttpResponse.Join: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuHttpResponse.protoMessageName + ".Join"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "started_at"),
    2: .standard(proto: "max_participants"),
  ...
  static func ==(lhs: Groupcall_SfuHttpResponse.Join, rhs: Groupcall_SfuHttpResponse.Join) -> Bool {
    if lhs.startedAt != rhs.startedAt {return false}
    if lhs.maxParticipants != rhs.maxParticipants {return false}
...
extension Groupcall_SfuHttpResponse.Join.Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuHttpResponse.Join.protoMessageName + ".Address"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_SfuHttpResponse.Join.Address, rhs: Groupcall_SfuHttpResponse.Join.Address) -> Bool {
...
extension Groupcall_SfuToParticipant: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SfuToParticipant"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_SfuToParticipant, rhs: Groupcall_SfuToParticipant) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_SfuToParticipant.Envelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuToParticipant.protoMessageName + ".Envelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "padding"),
    2: .same(proto: "relay"),
    3: .same(proto: "hello"),
  ...
  static func ==(lhs: Groupcall_SfuToParticipant.Envelope, rhs: Groupcall_SfuToParticipant.Envelope) -> Bool {
    if lhs.padding != rhs.padding {return false}
...
extension Groupcall_SfuToParticipant.Hello: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuToParticipant.protoMessageName + ".Hello"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_SfuToParticipant.Hello, rhs: Groupcall_SfuToParticipant.Hello) -> Bool {
...
extension Groupcall_SfuToParticipant.ParticipantJoined: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuToParticipant.protoMessageName + ".ParticipantJoined"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_SfuToParticipant.ParticipantJoined, rhs: Groupcall_SfuToParticipant.ParticipantJoined) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_SfuToParticipant.ParticipantLeft: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_SfuToParticipant.protoMessageName + ".ParticipantLeft"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "participant_id"),
  ]
  ...
  static func ==(lhs: Groupcall_SfuToParticipant.ParticipantLeft, rhs: Groupcall_SfuToParticipant.ParticipantLeft) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToSfu: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ParticipantToSfu"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu, rhs: Groupcall_ParticipantToSfu) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToSfu.Envelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.protoMessageName + ".Envelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "padding"),
    2: .same(proto: "relay"),
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.Envelope, rhs: Groupcall_ParticipantToSfu.Envelope) -> Bool {
    if lhs.padding != rhs.padding {return false}
    if lhs.content != rhs.content {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToSfu.UpdateCallState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.protoMessageName + ".UpdateCallState"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.UpdateCallState, rhs: Groupcall_ParticipantToSfu.UpdateCallState) -> Bool {
...
extension Groupcall_ParticipantToSfu.ParticipantMicrophone: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.protoMessageName + ".ParticipantMicrophone"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "participant_id"),
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantMicrophone, rhs: Groupcall_ParticipantToSfu.ParticipantMicrophone) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
...
extension Groupcall_ParticipantToSfu.ParticipantMicrophone.Subscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantMicrophone.protoMessageName + ".Subscribe"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.Subscribe, rhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.Subscribe) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToSfu.ParticipantMicrophone.Unsubscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantMicrophone.protoMessageName + ".Unsubscribe"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.Unsubscribe, rhs: Groupcall_ParticipantToSfu.ParticipantMicrophone.Unsubscribe) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToSfu.ParticipantCamera: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.protoMessageName + ".ParticipantCamera"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "participant_id"),
    2: .same(proto: "subscribe"),
    3: .same(proto: "unsubscribe"),
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantCamera, rhs: Groupcall_ParticipantToSfu.ParticipantCamera) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
    if lhs.action != rhs.action {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToSfu.ParticipantCamera.Subscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantCamera.protoMessageName + ".Subscribe"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantCamera.Subscribe, rhs: Groupcall_ParticipantToSfu.ParticipantCamera.Subscribe) -> Bool {
...
extension Groupcall_ParticipantToSfu.ParticipantCamera.Unsubscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantCamera.protoMessageName + ".Unsubscribe"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantCamera.Unsubscribe, rhs: Groupcall_ParticipantToSfu.ParticipantCamera.Unsubscribe) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToSfu.ParticipantScreen: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.protoMessageName + ".ParticipantScreen"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "participant_id"),
    2: .same(proto: "subscribe"),
    3: .same(proto: "unsubscribe"),
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantScreen, rhs: Groupcall_ParticipantToSfu.ParticipantScreen) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
    if lhs.action != rhs.action {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToSfu.ParticipantScreen.Subscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantScreen.protoMessageName + ".Subscribe"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantScreen.Subscribe, rhs: Groupcall_ParticipantToSfu.ParticipantScreen.Subscribe) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToSfu.ParticipantScreen.Unsubscribe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToSfu.ParticipantScreen.protoMessageName + ".Unsubscribe"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToSfu.ParticipantScreen.Unsubscribe, rhs: Groupcall_ParticipantToSfu.ParticipantScreen.Unsubscribe) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ParticipantToParticipant"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant, rhs: Groupcall_ParticipantToParticipant) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant.OuterEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".OuterEnvelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "sender"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.OuterEnvelope, rhs: Groupcall_ParticipantToParticipant.OuterEnvelope) -> Bool {
...
extension Groupcall_ParticipantToParticipant.Handshake: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".Handshake"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake, rhs: Groupcall_ParticipantToParticipant.Handshake) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".HelloEnvelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "padding"),
    2: .same(proto: "hello"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope, rhs: Groupcall_ParticipantToParticipant.Handshake.HelloEnvelope) -> Bool {
    if lhs.padding != rhs.padding {return false}
    if lhs.content != rhs.content {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".AuthEnvelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "padding"),
    2: .same(proto: "auth"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope, rhs: Groupcall_ParticipantToParticipant.Handshake.AuthEnvelope) -> Bool {
    if lhs.padding != rhs.padding {return false}
    if lhs.content != rhs.content {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToParticipant.Handshake.Hello: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".Hello"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "identity"),
    2: .same(proto: "nickname"),
    3: .same(proto: "pck"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.Hello, rhs: Groupcall_ParticipantToParticipant.Handshake.Hello) -> Bool {
    if lhs.identity != rhs.identity {return false}
    if lhs.nickname != rhs.nickname {return false}
...
extension Groupcall_ParticipantToParticipant.Handshake.Auth: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".Auth"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "pck"),
    2: .same(proto: "pcck"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.Auth, rhs: Groupcall_ParticipantToParticipant.Handshake.Auth) -> Bool {
    if lhs.pck != rhs.pck {return false}
    if lhs.pcck != rhs.pcck {return false}
...
extension Groupcall_ParticipantToParticipant.Handshake.GuestHello: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".GuestHello"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "pck"),
    3: .same(proto: "pcck"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.GuestHello, rhs: Groupcall_ParticipantToParticipant.Handshake.GuestHello) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.pck != rhs.pck {return false}
    if lhs.pcck != rhs.pcck {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Groupcall_ParticipantToParticipant.Handshake.GuestAuth: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Handshake.protoMessageName + ".GuestAuth"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "pck"),
    2: .same(proto: "pcck"),
    3: .standard(proto: "media_keys"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Handshake.GuestAuth, rhs: Groupcall_ParticipantToParticipant.Handshake.GuestAuth) -> Bool {
    if lhs.pck != rhs.pck {return false}
    if lhs.pcck != rhs.pcck {return false}
    if lhs.mediaKeys != rhs.mediaKeys {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Groupcall_ParticipantToParticipant.Envelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".Envelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "padding"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Envelope, rhs: Groupcall_ParticipantToParticipant.Envelope) -> Bool {
    if lhs.padding != rhs.padding {return false}
    if lhs.content != rhs.content {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Groupcall_ParticipantToParticipant.Admin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".Admin"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin, rhs: Groupcall_ParticipantToParticipant.Admin) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant.Admin.Envelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".Envelope"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.Envelope, rhs: Groupcall_ParticipantToParticipant.Admin.Envelope) -> Bool {
    if lhs.content != rhs.content {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToParticipant.Admin.ReportAsAdmin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".ReportAsAdmin"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.ReportAsAdmin, rhs: Groupcall_ParticipantToParticipant.Admin.ReportAsAdmin) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant.Admin.PromoteToAdmin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".PromoteToAdmin"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "gcak"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.PromoteToAdmin, rhs: Groupcall_ParticipantToParticipant.Admin.PromoteToAdmin) -> Bool {
...
extension Groupcall_ParticipantToParticipant.Admin.ForceLeave: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".ForceLeave"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.ForceLeave, rhs: Groupcall_ParticipantToParticipant.Admin.ForceLeave) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".ForceCaptureStateOff"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "device"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff, rhs: Groupcall_ParticipantToParticipant.Admin.ForceCaptureStateOff) -> Bool {
...
extension Groupcall_ParticipantToParticipant.Admin.ForceFocus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.Admin.protoMessageName + ".ForceFocus"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "participant_id"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.Admin.ForceFocus, rhs: Groupcall_ParticipantToParticipant.Admin.ForceFocus) -> Bool {
    if lhs.participantID != rhs.participantID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToParticipant.MediaKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".MediaKey"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "epoch"),
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.MediaKey, rhs: Groupcall_ParticipantToParticipant.MediaKey) -> Bool {
...
extension Groupcall_ParticipantToParticipant.CaptureState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".CaptureState"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "microphone"),
    2: .same(proto: "camera"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState, rhs: Groupcall_ParticipantToParticipant.CaptureState) -> Bool {
...
extension Groupcall_ParticipantToParticipant.CaptureState.Microphone: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.CaptureState.protoMessageName + ".Microphone"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "on"),
    2: .same(proto: "off"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Microphone, rhs: Groupcall_ParticipantToParticipant.CaptureState.Microphone) -> Bool {
    if lhs.state != rhs.state {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToParticipant.CaptureState.Camera: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.CaptureState.protoMessageName + ".Camera"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "on"),
    2: .same(proto: "off"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Camera, rhs: Groupcall_ParticipantToParticipant.CaptureState.Camera) -> Bool {
    if lhs.state != rhs.state {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToParticipant.CaptureState.Screen: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.CaptureState.protoMessageName + ".Screen"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "on"),
    2: .same(proto: "off"),
  ]
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.CaptureState.Screen, rhs: Groupcall_ParticipantToParticipant.CaptureState.Screen) -> Bool {
    if lhs.state != rhs.state {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Groupcall_ParticipantToParticipant.HoldState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Groupcall_ParticipantToParticipant.protoMessageName + ".HoldState"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Groupcall_ParticipantToParticipant.HoldState, rhs: Groupcall_ParticipantToParticipant.HoldState) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
