...
struct Url_DeviceGroupJoinRequestOrOffer {
  ...
  var version: Url_DeviceGroupJoinRequestOrOffer.Version = .v10

  var variant: Url_DeviceGroupJoinRequestOrOffer.Variant {
  ...
  struct Variant {
    ...
    var type: Url_DeviceGroupJoinRequestOrOffer.Variant.OneOf_Type? = nil
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Url_DeviceGroupJoinRequestOrOffer.Variant.OneOf_Type, rhs: Url_DeviceGroupJoinRequestOrOffer.Variant.OneOf_Type) -> Bool {
...
extension Url_DeviceGroupJoinRequestOrOffer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".DeviceGroupJoinRequestOrOffer"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Url_DeviceGroupJoinRequestOrOffer.Variant: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Url_DeviceGroupJoinRequestOrOffer.protoMessageName + ".Variant"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Url_DeviceGroupJoinRequestOrOffer.Variant, rhs: Url_DeviceGroupJoinRequestOrOffer.Variant) -> Bool {
