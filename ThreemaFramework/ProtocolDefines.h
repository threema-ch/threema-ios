...
static Float64 const kShareExtensionMaxImagePreviewSize = 10*1024*1024;
static Float64 const kShareExtensionMaxFileShareSize = 40*1024*1024;
static Float64 const kShareExtensionMaxImageShareSize = 25*1024*1024;
