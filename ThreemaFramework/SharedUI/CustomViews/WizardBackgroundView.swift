...
@objc public class WizardBackgroundView: UIView {
    ...
    func drawCanvas1(frame: CGRect = CGRect(x: 0, y: 0, width: 2890, height: 1380)) {
        ...
        let rectanglePath = UIBezierPath(rect: CGRect(
            ...
            width: fastFloor(wizardBgpdfGroup.width * 1.00000 + 0.5) -
                fastFloor(wizardBgpdfGroup.width * 0.00000 + 0.5),
            height: fastFloor(wizardBgpdfGroup.height * 1.00000 + 0.5) -
                fastFloor(wizardBgpdfGroup.height * 0.00000 + 0.5)
        ))
        fillColor.setFill()
        rectanglePath.fill()
        ...
        bezierPath.move(to: CGPoint(
            ...
            y: wizardBgpdfGroup.minY + 0.12246 * wizardBgpdfGroup.height
        ))
        bezierPath.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.23700 * wizardBgpdfGroup.height
        ))
        bezierPath.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ))
        bezierPath.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ...
        bezier2Path.move(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.00000 * wizardBgpdfGroup.height
        ))
        bezier2Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ))
        bezier2Path.addLine(to: CGPoint(
        ...
        bezier2Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.62747 * wizardBgpdfGroup.height
        ))
        bezier2Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.66701 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.00000 * wizardBgpdfGroup.height
        ))
        bezier2Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
        ...
        bezier3Path.move(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.26232 * wizardBgpdfGroup.height
        ))
        bezier3Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.69998 * wizardBgpdfGroup.height
        ))
        bezier3Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ...
        bezier4Path.move(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.36531 * wizardBgpdfGroup.height
        ))
        bezier4Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ))
        bezier4Path.addLine(to: CGPoint(
        ...
        bezier4Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.83415 * wizardBgpdfGroup.height
        ))
        bezier4Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.36531 * wizardBgpdfGroup.height
        ...
        bezier5Path.move(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.69783 * wizardBgpdfGroup.height
        ))
        bezier5Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.92059 * wizardBgpdfGroup.height
        ))
        bezier5Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ...
        bezier6Path.move(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.62617 * wizardBgpdfGroup.height
        ))
        bezier6Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 0.99968 * wizardBgpdfGroup.height
        ))
        bezier6Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 0.50000 * wizardBgpdfGroup.width,
            y: wizardBgpdfGroup.minY + 1.00000 * wizardBgpdfGroup.height
        ))
        bezier6Path.addLine(to: CGPoint(
            x: wizardBgpdfGroup.minX + 1.00000 * wizardBgpdfGroup.width,
