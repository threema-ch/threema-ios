...
class ChevronBackCircleImage {
    static func get() -> UIImage {
        ...
        let isDark = Colors.theme == .dark
        
        let lightThemelightGray = UIColor(red: 232 / 255, green: 232 / 255, blue: 234 / 255, alpha: 1.0)
        let lightThemedarkGray = UIColor(red: 129 / 255, green: 129 / 255, blue: 133 / 255, alpha: 1.0)
        
        let darkThemeLightGray = UIColor(red: 165 / 255, green: 165 / 255, blue: 171 / 255, alpha: 1.0)
        let darkThemeDarkGray = UIColor(red: 59 / 255, green: 59 / 255, blue: 61 / 255, alpha: 1.0)
