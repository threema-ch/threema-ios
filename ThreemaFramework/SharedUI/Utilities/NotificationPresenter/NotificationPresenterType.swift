...
public struct NotificationPresenterType {
    ...
    public static let linkMobileNoSuccess = NotificationPresenterType(
        notificationText: #localize("mobileno_linked_success"),
        notificationStyle: .success
    )
    public static let linkMobileNoFailed = NotificationPresenterType(
        notificationText: #localize("mobileno_linked_failed"),
        notificationStyle: .error
    )
    public static let addContactFailed = NotificationPresenterType(
