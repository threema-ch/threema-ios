...
+ (NSString *)generateText:(NSString *)text quotedId:(NSData *)quotedId {
    NSMutableString *quoteString = [[NSMutableString alloc] initWithString:@"> quote #"];
    [quoteString appendString:[NSString stringWithHexData:quotedId]];
    
    [quoteString appendString:@"\n\n"];
    [quoteString appendString:text];
