...
final class MessageStoreMock: MessageStoreProtocol {
    ...
    func save(
        ...
        reflectedAt: Date,
        isOutgoing: Bool
    ) throws -> PromiseKit.Promise<Void> {
        Promise()
    }
    ...
    func save(groupLeaveMessage amsg: GroupLeaveMessage, createdAt: Date, reflectedAt: Date, isOutgoing: Bool) {
        // no-op
    }
