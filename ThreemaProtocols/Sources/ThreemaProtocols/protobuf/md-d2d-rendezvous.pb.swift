...
// transmitted data even if the transport supports datagrams. This
// intentionally allows to fragment a frame across multiple datagrams (e.g.
// useful for limited APIs that cannot deliver data in a streamed fashion).
//
// ### Key Derivation
//
