...
public struct Url_DeviceGroupJoinRequestOrOffer: Sendable {
  ...
  public var variant: Url_DeviceGroupJoinRequestOrOffer.Variant {
    get {_variant ?? Url_DeviceGroupJoinRequestOrOffer.Variant()}
    set {_variant = newValue}
  }
  /// Returns true if `variant` has been explicitly set.
  public var hasVariant: Bool {self._variant != nil}
  ...
  public var rendezvousInit: D2dRendezvous_RendezvousInit {
    get {_rendezvousInit ?? D2dRendezvous_RendezvousInit()}
    set {_rendezvousInit = newValue}
  }
  /// Returns true if `rendezvousInit` has been explicitly set.
  public var hasRendezvousInit: Bool {self._rendezvousInit != nil}
  ...
  fileprivate var _rendezvousInit: D2dRendezvous_RendezvousInit? = nil
}
