...
open class DKPopoverViewController: UIViewController {
    ...
    func showInView(_ view: UIView) {
        ...
        UIView.animate(withDuration: 0.6, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 1.3, options: .allowUserInteraction, animations: {
            ...
            UIAccessibility.post(notification: UIAccessibility.Notification.screenChanged, argument: self.popoverView);
        }, completion: nil)
    }
    ...
    @objc func dismiss() {
        ...
        UIView.animate(withDuration: 0.2, animations: {
            ...
            UIAccessibility.post(notification: UIAccessibility.Notification.screenChanged, argument: self.contentViewController);
        })
    }
