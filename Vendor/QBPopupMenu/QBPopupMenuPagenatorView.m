...
{
    return [[self alloc] initWithArrowDirection:QBPopupMenuPagenatorDirectionLeft target:target action:action accessibilityLabel:accessibilityLabel];
}

/* Custom */
+ (instancetype)rightPagenatorViewWithTarget:(id)target action:(SEL)action accessibilityLabel:(NSString *)accessibilityLabel
{
    return [[self alloc] initWithArrowDirection:QBPopupMenuPagenatorDirectionRight target:target action:action accessibilityLabel:(NSString *)accessibilityLabel];
}
